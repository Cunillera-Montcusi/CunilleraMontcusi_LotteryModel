...
plot_Orig_RCperc <- function(Orig_rec, Pre_fire_Orig, titol){
...
plot_RR_iter(Orig_rec =Orig_rec_ENTRADA_0.1_100 , titol = "A-0.1")
plot_Orig_RCperc(Orig_rec =Orig_rec_ENTRADA_0.1_100 , Pre_fire_Orig=Orig_rec_ENTRADA_0.1, titol = "B-0.1")
par(las=1)
plot_RR_iter(Orig_rec =Orig_rec_ENTRADA_0.3_100 , titol = "A-0.3")
plot_Orig_RCperc(Orig_rec =Orig_rec_ENTRADA_0.3_100 , Pre_fire_Orig=Orig_rec_ENTRADA_0.3, titol = "B-0.3")
par(las=1)
plot_RR_iter(Orig_rec =Orig_rec_ENTRADA_0.5_100 , titol = "A-0.5")
plot_Orig_RCperc(Orig_rec =Orig_rec_ENTRADA_0.5_100 , Pre_fire_Orig=Orig_rec_ENTRADA_0.5, titol = "B-0.5")
par(las=1)
plot_RR_iter(Orig_rec =Orig_rec_ENTRADA_0.7_100 , titol = "A-0.7")
plot_Orig_RCperc(Orig_rec =Orig_rec_ENTRADA_0.7_100 , Pre_fire_Orig=Orig_rec_ENTRADA_0.7, titol = "B-0.7")
par(las=1)
plot_RR_iter(Orig_rec =Orig_rec_ENTRADA_0.9_100 , titol = "A-0.9")
plot_Orig_RCperc(Orig_rec =Orig_rec_ENTRADA_0.9_100 , Pre_fire_Orig=Orig_rec_ENTRADA_0.9, titol = "B-0.9")
dev.off()
...
plot_RR_iter(Orig_rec =Orig_rec_ENTRADA_0.5_100, titol = "")
plot_Orig_RCperc(Orig_rec =Orig_rec_ENTRADA_0.5_100 , Pre_fire_Orig=Orig_rec_ENTRADA_0.5,titol="")
dev.off()
...
## Mean richness SD plot (Supplementary S6) ____________________________________________####
...
# DR __________________________________________________________________________________________________________####
#############################################################################################################################
#############################################################################################################################
...
# Richness at T100____________________________________________________________________________________________####
#############################################################################################################################
#############################################################################################################################
